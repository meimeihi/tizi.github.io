...
<table width="98%" border="0" align="center" cellpadding="4" cellspacing="0" id="config0" class="tableConfig">
	...
	<tr class="tdbg">
      <td align="right" class="config_td_first">站群池状态：</td>
      <td><label><input type="radio" name="con[web_open]" value="1"<?php if($this->_var['web_open']): ?> checked<?php endif; ?>>开启</label>
	...
	<tr class="tdbg">
      ...
      <td><label><input type="radio" name="con[web_user_ban]" value="1"<?php if($this->_var['web_user_ban']): ?> checked<?php endif; ?>>是</label>
	...
	<tr class="tdbg">
      <td align="right" class="config_td_first">屏蔽其他域名：</td>
		<td><label><input type="radio" name="con[web_limit_domain_type]" value="301" <?php if($this->_var['web_limit_domain_type'] == 301): ?> checked<?php endif; ?>>随机重定向到现有域名</label>
				...
				<span class="tips">（非网站管理添加的域名将被屏蔽！）</span>
			</td>
    </tr>

	<tr class="tdbg">
      <td align="right" class="config_td_first">游客访问跳转：</td>
      <td><label><input type="radio" name="con[web_user_jump]" value="1"<?php if($this->_var['web_user_jump']): ?> checked<?php endif; ?>>是</label>
	...
	<tr class="tdbg">
      ...
      <td><textarea name="con[web_tongji]"  rows="3"  class="inputs" style="width:450px;padding:1px;"><?php echo $this->_var['web_tongji']; ?></textarea></td>
    </tr>

	<tr class="tdbg">
      <td align="right" class="config_td_first">百度JS自动推送代码：</td>
      <td><textarea name="con[web_bdpush]"  rows="3"  class="inputs" style="width:450px;padding:1px;"><?php echo $this->_var['web_bdpush']; ?></textarea></td>
    </tr>

	<tr class="tdbg">
      <td align="right" class="config_td_first">分享代码：</td>
      <td><textarea name="con[web_share]"  rows="3"  class="inputs" style="width:450px;padding:1px;"><?php echo $this->_var['web_share']; ?></textarea></td>
    </tr>

	<tr class="tdbg">
      <td align="right" class="config_td_first">页面顶部插入代码：</td>
      <td><label><input type="radio" name="con[web_inserttop]" value="1"<?php if($this->_var['web_inserttop']): ?> checked<?php endif; ?>>是</label>
	...
	<tr class="tdbg">
      ...
      <td><textarea name="con[web_inserttop_code]"  rows="3"  class="inputs" style="width:450px;padding:1px;"><?php echo $this->_var['web_inserttop_code']; ?></textarea></td>
    </tr>
...
<table width="98%" border="0" align="center" cellpadding="4" cellspacing="0" id="config1" style="display:none" class="tableConfig">
	...
	<tr class="tdbg">
      ...
      <td><label><input type="radio" name="con[web_gzip_open]" value="1"<?php if($this->_var['web_gzip_open']): ?> checked<?php endif; ?>>开启</label>
	...
	<tr class="tdbg">
      ...
      <td><label><input type="radio" name="con[web_debug]" value="1"<?php if($this->_var['web_debug']): ?> checked<?php endif; ?>>开启</label>
